    ...
    <section class="page-section" id="services">
        <div class="container">
            <div class="row text-center">
                ...
                <div class="col-md-2">
                    <a href="{{ route('babycamp.arrival') }}" style="text-decoration: none">
                ...
                <div class="col-md-2">
                    <a href="{{ route('babycamp.learning1') }}" style="text-decoration: none">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                ...
                <div class="col-md-2">
                    <a href="{{ route('babycamp.learning2') }}" style="text-decoration: none">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                ...
                <div class="col-md-2">
                    <a href="{{ route('babycamp.playingtime') }}" style="text-decoration: none">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
