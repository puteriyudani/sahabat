...
@section('judul')
    <title>Kindergarten - Playing Time</title>
@endsection
...
<header class="masthead2">
    <div class="container">
        ...
        <div class="masthead2-heading text-uppercase">Playing Time</div>
    </div>
</header>
    ...
    <div class="container mt-3">
        <form action="" method="POST">
            ...
            <div class="row text-center mt-5">
                <p style="font-size: 20px">Bagaimana permainan kita hari ini?</p>
            </div>
            ...
            <div class="row text-center mt-5 mb-5">
                ...
                <div class="col-md-6">
                    <input type="radio" class="btn-check" name="breakfast" id="nothappy" autocomplete="off">
                    <label class="btn" for="nothappy">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                            <i class="fas fa-face-frown fa-stack-1x fa-inverse"></i>
                        </span>
                        <h4 class="my-3" style="color: var(--bs-link-color);">Not Happy</h4>
                    </label>
                </div>
            </div>
        </form>
