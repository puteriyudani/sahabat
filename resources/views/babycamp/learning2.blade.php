...
@section('judul')
    <title>Kindergarten - Learning 2</title>
@endsection
...
<header class="masthead2">
    <div class="container">
        ...
        <div class="masthead2-heading text-uppercase">Learning 2</div>
    </div>
</header>
    ...
    <div class="container mt-3">
        <form action="" method="POST">
            ...
            <div class="row text-center mt-5">
                <p style="font-size: 20px">Bagaimana pelajaran kedua hari ini?</p>
            </div>
