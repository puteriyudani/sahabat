...
@section('judul')
    <title>Kindergarten - Indikator Kegiatan Pembuka</title>
@endsection
...
<header class="masthead2">
    <div class="container">
        ...
        <div class="masthead2-heading text-uppercase">Indikator Kegiatan Pembuka</div>
    </div>
</header>
            ...
            <div class="row">
                <div class="col-md-3">
                    <input type="hidden" class="form-control" id="kategori" name="kategori"
                        aria-describedby="kategoriHelp" value="pembuka" readonly>
                </div>
            </div>
        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project details-->
                                    <h2 class="text-uppercase">Bagaimana kegiatan pembuka hari ini?</h2>
