                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @foreach ($galerys as $galery)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td class="px-4 py-3 text-sm">{{ $galery->kategori }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $galery->judul }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $galery->detail }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $galery->tanggal }}</td>
                                    <td class="px-4 py-3 text-sm">{{ $galery->link }}</td>
                                    <td class="px-4 py-3 text-sm">
                                        <div class="flex items-center space-x-4 text-sm">
                                            <a href="{{ route('galery-image.index', $galery->id) }}">
                                                <button
