            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>Gallery - Malming</h1>
                            <p class="mb-0">Kadang rutin kadang tidak, kegiatan malam minggu.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="gallery" class="gallery section">
            ...
            <div class="container-fluid" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4 justify-content-center">
                    ...
                    @foreach ($malmings as $malming)
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="{{ asset('storage/images/' . $malming->images->first()->image) }}" class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="{{ asset('storage/images/' . $malming->images->first()->image) }}" title="{{ $malming->judul }}"
                                        class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                                    <a href="{{ route('galery-detail', $malming->id) }}" class="details-link"><i class="bi bi-link-45deg"></i></a>
                                </div>
                            </div>
