            ...
            <div class="heading">
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            <h1>Gallery - Acara</h1>
                            <p class="mb-0">Nikahan, kenduri, aqiqah, dll.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    @foreach ($acaras as $acara)
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="{{ asset('storage/images/' . $acara->images->first()->image) }}" class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="{{ asset('storage/images/' . $acara->images->first()->image) }}" title="{{ $acara->judul }}"
                                        class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                                    <a href="{{ route('galery-detail', $acara->id) }}" class="details-link"><i class="bi bi-link-45deg"></i></a>
                                </div>
                            </div>
