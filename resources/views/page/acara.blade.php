                    ...
                    @foreach ($acaras as $acara)
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="{{ asset('storage/images/' . $acara->images->first()->image) }}"
                                    class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="{{ asset('storage/images/' . $acara->images->first()->image) }}"
                                        title="{{ $acara->judul }}" class="glightbox preview-link"><i
                                            class="bi bi-arrows-angle-expand"></i></a>
                                    <a href="{{ route('galery-detail', $acara->id) }}" class="details-link"><i
