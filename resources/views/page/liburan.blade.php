                ...
                <div class="container">
                    <div class="row d-flex justify-content-center text-center">
                        <div class="col-lg-8">
                            ...
                            <p class="mb-0">Melakukan perjalanan yang jauh pokoknya.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    @foreach ($liburans as $liburan)
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="{{ asset('storage/images/' . $liburan->images->first()->image) }}"
                                    class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="{{ asset('storage/images/' . $liburan->images->first()->image) }}"
                                        title="{{ $liburan->judul }}" class="glightbox preview-link"><i
                                            class="bi bi-arrows-angle-expand"></i></a>
                                    <a href="{{ route('galery-detail', $liburan->id) }}" class="details-link"><i
